...
public class ReceiveAmountActivityGold extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref2 = ref2.child(USER + GOLD + "/Chits/");
    ...
    private void getMoneyDetails() {
        ...
        ref2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    while (chitIds.hasNext()) {
                        ...
                        if (chitId.equals(id)) {
                            ...
                            while (members.hasNext()) {
                                ...
                                String name = memberList.child("name").getValue(String.class);
                ...
                ReceiveAmountAdapter adapter = new ReceiveAmountAdapter(listAll, ReceiveAmountActivityGold.this);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                while (memberList.hasNext()) {
                    ...
                    Iterator<DataSnapshot> chitList = member.child("/golds").getChildren().iterator();
                ...
                ArrayAdapter adapter = new ArrayAdapter(ReceiveAmountActivityGold.this, android.R.layout.simple_dropdown_item_1line, names);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.calculate:
                ...
                break;
            case R.id.receive:
                showProgress(ReceiveAmountActivityGold.this, "");
                ...
                ref3.child("sheet/"+key+"/ref").setValue("gold");
        }
    }
}
